...
from app.api.models.event_descriptor import EventDescriptor
from app.api.models.group import Group
from app.api.models.user_group_association import UserGroupAssociation
...
def seed_db():
    ...
    user1 = User(email="a@a.com", password="password",
                 cellphone_number="98983510", cellphone_cc="+598",
                 given_name="Pleroma", family_name="Ligth")
